package schule.planetdefender.ui.screen.component;
...
public abstract class AbstractComponent implements IEntityRenderable {
    ...
    public AbstractComponent(Point pos, Dimension dim, Color bgColor, Point posOffset, int screenWidth, int screenHeight) {
