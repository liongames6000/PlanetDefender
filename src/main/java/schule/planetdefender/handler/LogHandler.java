    ...
    private void writeToLogFile(String msg) {
        ...
        try {
            if(file.exists()) {
                ...
                log(textHandler.successCreatedFileMsg(filePath), "writeToLogFile", LogLevel.INFO, false);
            }
        } catch (IOException e) {
            log(textHandler.errorWritingToFileMsg(filePath, ExceptionUtils.getStackTrace(e)), "writeToFile", LogLevel.ERROR, false);
        }
    }
